...
values (1, '2024-10-01', '2024-10-15'),
       ...
       (3, '2024-10-10', null),         -- nie zwrocono jeszcze
       (4, '2024-10-11', '2024-10-17'), -- Marek
       (5, '2024-10-09', '2024-10-20'), -- Zofia
       (6, '2024-10-12', null),         -- Tomasz, nie zwrocono jeszcze
       (1, '2024-10-15', null);         -- drugie wypozyczenie Jana

-- Wstawianie danych do tabeli wypozyczenie_ksiazki (relacja m:n)
insert into wypozyczenie_ksiazki (ksiazka_id, wypozyczenie_id)
values (1, 1), -- Jan wypożyczyl Wiedzmin
       (2, 2), -- Anna wypożyczyl Lalka
       (3, 3), -- Piotr wypożyczyl Krzyzacy
       (4, 4), -- Marek wypożyczyl Pan Tadeusz
       (5, 4), -- Marek wypożyczyl Quo Vadis
       (6, 5), -- Zofia wypożyczyl Ogniem i Mieczem
       (7, 5), -- Zofia wypożyczyl Faraon
       (8, 6), -- Tomasz wypożyczyl Ludzie Bezdomni
       (1, 7), -- Jan wypożyczyl ponownie Wiedzmin
       (3, 7); -- Jan wypożyczyl tym razem Krzyzacy

-- Wstawianie danych do tabeli kara (w tym wpis 'bez kary')
insert into kara (kara_id, opoznienie_min, opoznienie_max, kwota)
values (0, 0, 6, 0); -- brak kary za opoznienie do 6 dni
insert into kara (opoznienie_min, opoznienie_max, kwota)
values (7, 14, 10); -- 10 PLN kary za opoznienie 7-14 dni
insert into kara (opoznienie_min, opoznienie_max, kwota)
values (15, 9999, 50); -- 50 PLN kary za opoznienie powyżej 15 dni
